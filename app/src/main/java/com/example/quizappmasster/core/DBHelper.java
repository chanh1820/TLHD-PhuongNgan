package com.example.quizappmasster.core;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_PATH = "/data/data/com.example.quizappmasster/databases/";
    private static final String DB_NAME = "quizappmaster.sqlite";
